...
<<<<<<< HEAD:clean_uspatentcitation_chunk.py
df=pd.read_csv(file, compression='zip', sep="\t", chunksize=10000, error_bad_lines=False, encoding="utf-8", usecols=['patent_id', 'citation_id', 'date'])
=======

df=dd.read_csv(file, compression='zip', sep="\t", error_bad_lines=False, encoding="utf-8", usecols=['patent_id', 'citation_id', 'date'])
>>>>>>> dd does not accept chunksize, corrected:clean_uspatentcitation_dd.py
